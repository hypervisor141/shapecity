...
public final class Animations{
    ...
    public static final float[] COLOR_BLUE_LESS2 = new float[]{ 0F, 0.698F, 0.6F, 1F };
    ...
    public static final float[] COLOR_LAYER = COLOR_OBSIDIAN_LESS3;
    private static final float[] COLOR_BLINK = COLOR_OBSIDIAN_LESS3;
    private static final float[] COLOR_DEACTIVATED = COLOR_OBSIDIAN_LESS5;
    public static final float[] COLOR_STANDBY = COLOR_PURPLE_MORE;

    public static final VLVCurved.Curve CURVE_TYPE = VLVCurved.CURVE_DEC_COS_SQRT;
    ...
    public static void initialize(Loader loader){
        ...
        VLVManager main = loader.vManager();
        main.add(rootmanager);
        main.add(controlmanager);
    }
