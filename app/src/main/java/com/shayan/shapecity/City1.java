...
public final class City1{
    ...
    public static void register(Gen gen, FSGAutomator automator){
        pieces = gen.register(gen.bppieces, "pieces.", Puzzle.COLOR_LAYER, Gen.MATERIAL_WHITE_MORE_SPECULAR);
        platform = gen.register(gen.bpsingular, "platform_Cube.637", Animation.COLOR_ORANGE, Gen.MATERIAL_WHITE);
        puzzlebase = gen.register(gen.bpsingular, "puzzlebase_Cube.036", Animation.COLOR_PURPLE_MORE, Gen.MATERIAL_WHITE);
        puzzlebase_lining = gen.register(gen.bpsingular, "puzzlebase_lining_Cube.634", Animation.COLOR_BLUE, Gen.MATERIAL_WHITE);
        puzzlebase_innerwalls1_frame = gen.register(gen.bpsingular, "puzzlebase_innerwalls1_frame_Cube.024", Animation.COLOR_BLUE, Gen.MATERIAL_WHITE_LESS_SPECULAR);
        puzzlebase_innerwalls1_linings1 = gen.register(gen.bpsingular, "puzzlebase_innerwalls1_linings1_Cube.028", Animation.COLOR_BLUE_LESS1, Gen.MATERIAL_WHITE_LESS_SPECULAR);
        puzzlebase_innerwalls1_linings2 = gen.register(gen.bpsingular, "puzzlebase_innerwalls1_linings2_Cube.029", Animation.COLOR_BLUE_LESS2, Gen.MATERIAL_WHITE_LESS_SPECULAR);
        puzzlebase_innerwalls1_linings3 = gen.register(gen.bpsingular, "puzzlebase_innerwalls1_linings3_Cube.030", Animation.COLOR_BLUE_LESS3, Gen.MATERIAL_WHITE_LESS_SPECULAR);
        puzzlebase_innerwalls1_linings4 = gen.register(gen.bpsingular, "puzzlebase_innerwalls1_linings4_Cube.031", Animation.COLOR_BLUE_LESS4, Gen.MATERIAL_WHITE_LESS_SPECULAR);
        puzzlebase_innerwalls1_linings5 = gen.register(gen.bpsingular, "puzzlebase_innerwalls1_linings5_Cube.032", Animation.COLOR_BLUE_LESS5, Gen.MATERIAL_WHITE_LESS_SPECULAR);
        puzzlebase_innerwalls1_linings6 = gen.register(gen.bpsingular, "puzzlebase_innerwalls1_linings6_Cube.033", Animation.COLOR_BLUE_LESS6, Gen.MATERIAL_WHITE_LESS_SPECULAR);
        puzzlebase_innerwalls1_linings7 = gen.register(gen.bpsingular, "puzzlebase_innerwalls1_linings7_Cube.034", Animation.COLOR_BLUE_LESS7, Gen.MATERIAL_WHITE_LESS_SPECULAR);
        puzzlebase_innerwalls1_linings8 = gen.register(gen.bpsingular, "puzzlebase_innerwalls1_linings8_Cube.035", Animation.COLOR_BLUE_LESS8, Gen.MATERIAL_WHITE_LESS_SPECULAR);
        puzzlebase_innerwalls2 = gen.register(gen.bpsingular, "puzzlebase_innerwalls2_Cube.025", Animation.COLOR_PURPLE_MORE, Gen.MATERIAL_WHITE_LESS_SPECULAR);
        puzzlebase_bottom = gen.register(gen.bpsingular, "puzzlebase_bottom_Cube.026", Animation.COLOR_BLUE, Gen.MATERIAL_WHITE_LESS_SPECULAR);
        mainbase1 = gen.register(gen.bpsingular, "mainbase1_Cube.037", Animation.COLOR_RED_LESS1, Gen.MATERIAL_WHITE);
        mainbase2 = gen.register(gen.bpsingular, "mainbase2_Cube.157", Animation.COLOR_PURPLE_MORE, Gen.MATERIAL_WHITE);
        phase1_base = gen.register(gen.bpinstanced, "phase1_base_Cube.027", Animation.COLOR_PURPLE_MORE, Gen.MATERIAL_WHITE);
        phase1_base_inner = gen.register(gen.bpinstanced, "phase1_base_inner_Cube.039", Animation.COLOR_PURPLE_LESS, Gen.MATERIAL_WHITE);
        phase1_base_inner_lining = gen.register(gen.bpinstanced, "phase1_base_inner_lining_Cube.040", Animation.COLOR_BLUE_LESS6, Gen.MATERIAL_WHITE);
        phase1_pillars = gen.register(gen.bpinstanced, "phase1_pillar.", Animation.COLOR_BLUE, Gen.MATERIAL_WHITE);
        phase1_pillars_stripes = gen.register(gen.bpinstanced, "phase1_pillars_stripe.", Animation.COLOR_OBSIDIAN_LESS3, Gen.MATERIAL_WHITE);
        phase2 = gen.register(gen.bpinstanced, "phase2.", Animation.COLOR_OBSIDIAN_LESS4, Gen.MATERIAL_WHITE);
        phase2_stripes = gen.register(gen.bpinstanced, "phase2_stripe.", Animation.COLOR_BLUE, Gen.MATERIAL_WHITE);
        phase2_caps = gen.register(gen.bpinstanced, "phase2_cap.", Animation.COLOR_BLUE, Gen.MATERIAL_WHITE);
        phase3 = gen.register(gen.bpinstanced, "phase3.", Animation.COLOR_OBSIDIAN_LESS4, Gen.MATERIAL_WHITE);
        phase3_caps = gen.register(gen.bpinstanced, "phase3_cap.", Animation.COLOR_BLUE, Gen.MATERIAL_WHITE);
        phase3_blades = gen.register(gen.bpinstanced, "phase3_blade.", Animation.COLOR_OBSIDIAN_LESS1, Gen.MATERIAL_WHITE);
        phase3_baseframe1 = gen.register(gen.bpinstanced, "phase3_baseframe1.", Animation.COLOR_BLUE, Gen.MATERIAL_WHITE);
        phase3_baseframe2 = gen.register(gen.bpinstanced, "phase3_baseframe2.", Animation.COLOR_BLUE_LESS3, Gen.MATERIAL_WHITE);
        phase3_baseframe3 = gen.register(gen.bpinstanced, "phase3_baseframe3.", Animation.COLOR_BLUE_LESS4, Gen.MATERIAL_WHITE);
        phase3_baseframe4 = gen.register(gen.bpinstanced, "phase3_baseframe4.", Animation.COLOR_BLUE_LESS7, Gen.MATERIAL_WHITE);
        phase4 = gen.register(gen.bpinstanced, "phase4.", Animation.COLOR_OBSIDIAN_LESS4, Gen.MATERIAL_WHITE);
        phase4_caps = gen.register(gen.bpinstanced, "phase4_cap.", Animation.COLOR_BLUE_LESS3, Gen.MATERIAL_WHITE);
        phase4_caps2 = gen.register(gen.bpinstanced, "phase4_cap2.", Animation.COLOR_BLUE, Gen.MATERIAL_WHITE);
        phase5_layer1 = gen.register(gen.bpinstanced, "phase5_layer1.", Animation.COLOR_OBSIDIAN_LESS2, Gen.MATERIAL_WHITE);
        phase5_layer2 = gen.register(gen.bpinstanced, "phase5_layer2.", Animation.COLOR_OBSIDIAN_LESS3, Gen.MATERIAL_WHITE);
        phase5_layer3 = gen.register(gen.bpinstanced, "phase5_layer3.", Animation.COLOR_OBSIDIAN_LESS4, Gen.MATERIAL_WHITE);
        phase5_layer1_stripes = gen.register(gen.bpinstanced, "phase5_layer1_stripe.", Animation.COLOR_BLUE, Gen.MATERIAL_WHITE);
        phase5_layer2_stripes = gen.register(gen.bpinstanced, "phase5_layer2_stripe.", Animation.COLOR_BLUE, Gen.MATERIAL_WHITE);
        phase5_layer3_stripes = gen.register(gen.bpinstanced, "phase5_layer3_stripe.", Animation.COLOR_BLUE, Gen.MATERIAL_WHITE);
        phase5_caps = gen.register(gen.bpinstanced, "phase5_cap.", Animation.COLOR_BLUE, Gen.MATERIAL_WHITE);
        phase5_trapezoidx1 = gen.register(gen.bpinstanced, "phase5_trapezoidx1.", Animation.COLOR_OBSIDIAN_LESS2, Gen.MATERIAL_WHITE);
        phase5_trapezoidy1 = gen.register(gen.bpinstanced, "phase5_trapezoidy1.", Animation.COLOR_OBSIDIAN_LESS2, Gen.MATERIAL_WHITE);
        phase5_trapezoidx2 = gen.register(gen.bpinstanced, "phase5_trapezoidx2.", Animation.COLOR_OBSIDIAN_LESS3, Gen.MATERIAL_WHITE);
        phase5_trapezoidy2 = gen.register(gen.bpinstanced, "phase5_trapezoidy2.", Animation.COLOR_OBSIDIAN_LESS3, Gen.MATERIAL_WHITE);
        phase6_layer1 = gen.register(gen.bpinstanced, "phase6_layer1.", Animation.COLOR_BLUE, Gen.MATERIAL_WHITE);
        phase6_layer2 = gen.register(gen.bpinstanced, "phase6_layer2.", Animation.COLOR_OBSIDIAN_LESS3, Gen.MATERIAL_WHITE);
        phase6_layer3 = gen.register(gen.bpinstanced, "phase6_layer3.", Animation.COLOR_BLUE_LESS1, Gen.MATERIAL_WHITE);
        phase6_layer4 = gen.register(gen.bpinstanced, "phase6_layer4.", Animation.COLOR_BLUE_LESS2, Gen.MATERIAL_WHITE);
        phase6_layer5 = gen.register(gen.bpinstanced, "phase6_layer5.", Animation.COLOR_BLUE_LESS3, Gen.MATERIAL_WHITE);
        phase6_layer6 = gen.register(gen.bpinstanced, "phase6_layer6.", Animation.COLOR_BLUE_LESS4, Gen.MATERIAL_WHITE);
        phase6_layer7 = gen.register(gen.bpinstanced, "phase6_layer7.", Animation.COLOR_BLUE_LESS5, Gen.MATERIAL_WHITE);
        phase6_layer8 = gen.register(gen.bpinstanced, "phase6_layer8.", Animation.COLOR_BLUE_LESS6, Gen.MATERIAL_WHITE);
        phase6_layer9 = gen.register(gen.bpinstanced, "phase6_layer9.", Animation.COLOR_BLUE_LESS7, Gen.MATERIAL_WHITE);
        phase6_layer10 = gen.register(gen.bpinstanced, "phase6_layer10.", Animation.COLOR_BLUE_LESS8, Gen.MATERIAL_WHITE);
        phase6_layer11 = gen.register(gen.bpinstanced, "phase6_layer11.", Animation.COLOR_BLUE, Gen.MATERIAL_WHITE);
    }
