...
public final class Loader extends FSG{
    ...
    public void assemble(FSActivity act){
        ...
        layer1 = register(bplayer, "pieces1.", Animations.COLOR_LAYER, MATERIAL_WHITE);
        layer2 = register(bplayer, "pieces2.", Animations.COLOR_LAYER, MATERIAL_WHITE);
        layer3 = register(bplayer, "pieces3.", Animations.COLOR_LAYER, MATERIAL_WHITE);
        ...
        phase1_walls_stripes = register(bpsingular, "phase1_walls_stripes_Cube.531", Animations.COLOR_RED, MATERIAL_WHITE);
        phase1_walls_caps = register(bpsingular, "phase1_walls_caps_Cube.468", Animations.COLOR_RED_LESS2, MATERIAL_WHITE);
        phase1_pillars = register(bpinstanced, "phase1_pillars.", Animations.COLOR_OBSIDIAN_LESS4, MATERIAL_WHITE);
        phase1_pillars_stripes = register(bpsingular, "phase1_pillars_stripes_Cube.321", Animations.COLOR_RED, MATERIAL_WHITE);
        ...
        phase2_pillar_stripes = register(bpsingular, "phase2_pillars_stripes_Cube.573", Animations.COLOR_GOLD, MATERIAL_WHITE);
        phase3_rect_layer1 = register(bpinstanced, "phase3_rect_layer1.", Animations.COLOR_OBSIDIAN_LESS3, MATERIAL_WHITE);
        phase3_rect_layer2 = register(bpinstanced, "phase3_rect_layer2.", Animations.COLOR_OBSIDIAN_LESS4, MATERIAL_WHITE);
        phase3_rect_layer3 = register(bpinstanced, "phase3_rect_layer3.", Animations.COLOR_OBSIDIAN_LESS5, MATERIAL_WHITE);
        phase3_rect_layer4 = register(bpinstanced, "phase3_rect_layer4.", Animations.COLOR_RED, MATERIAL_WHITE);
        phase3_trapezoidx1 = register(bpinstanced, "phase3_trapezoidx1.", Animations.COLOR_GOLD, MATERIAL_WHITE);
        phase3_trapezoidx2 = register(bpinstanced, "phase3_trapezoidx2.", Animations.COLOR_GOLD, MATERIAL_WHITE);
        phase3_trapezoidy1 = register(bpinstanced, "phase3_trapezoidy1.", Animations.COLOR_GOLD, MATERIAL_WHITE);
        phase3_trapezoidy2 = register(bpinstanced, "phase3_trapezoidy2.", Animations.COLOR_GOLD, MATERIAL_WHITE);
        phase3_outrect = register(bpinstanced, "phase3_outrect.", Animations.COLOR_OBSIDIAN_LESS4, MATERIAL_WHITE);
        phase3_outrect_base_layer1 = register(bpsingular, "phase3_outrect_base_layer1_Cube.073", Animations.COLOR_GOLD, MATERIAL_WHITE);
        phase3_outrect_base_layer2 = register(bpsingular, "phase3_outrect_base_layer2_Cube.074", Animations.COLOR_OBSIDIAN_LESS4, MATERIAL_WHITE);
        phase3_outrect_base_layer3 = register(bpsingular, "phase3_outrect_base_layer3_Cube.075", Animations.COLOR_GOLD, MATERIAL_WHITE);
        phase3_outrect_inneredges = register(bpsingular, "phase3_outrect_inneredges_Cube.525", Animations.COLOR_GOLD, MATERIAL_WHITE);
        phase3_outrect_outeredges = register(bpsingular, "phase3_outrect_outeredges_Cube.307", Animations.COLOR_GOLD, MATERIAL_WHITE);
        phase3_outrect_outeredges_tops = register(bpsingular, "phase3_outrect_outeredges_tops_Cube.348", Animations.COLOR_OBSIDIAN_LESS4, MATERIAL_WHITE);
        outbase_walls = register(bpinstanced, "outbase_walls.", Animations.COLOR_OBSIDIAN_LESS4, MATERIAL_WHITE);
        ...
        puzzlebase = register(bpsingular, "puzzlebase_Cube.036", Animations.COLOR_OBSIDIAN_LESS1, MATERIAL_WHITE);
