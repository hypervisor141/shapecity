...
public final class Phase1{
    ...
    public static void initialize(Gen gen){
        ...
        Animation.lower(runner_centerpieces, CYCLES_APPEAR, 10F, new FSMesh[]{
        ...
        Animation.lower(runner_walls, CYCLES_APPEAR, 64F, new FSMesh[]{
                gen.phase1_walls,
                gen.phase1_walls_stripes,
                gen.phase1_walls_caps
        });
        Animation.lower(runner_pillars, CYCLES_APPEAR, 289F, new FSMesh[]{
                gen.phase1_pillars,
                gen.phase1_pillars_caps,
                gen.phase1_pillars_blades
        });
        Animation.lower(runner_pillars_baseframes, CYCLES_APPEAR, 134F, new FSMesh[]{
