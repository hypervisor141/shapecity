...
public class Phase2{
    ...
    public static void initialize(Gen gen){
        ...
        Animation.lower(runner_pillars, CYCLES_APPEAR, 309, 0, VLVCurved.CURVE_DEC_SINE_SQRT, new FSMesh[]{
                gen.phase2_pillars
        });
        Animation.lower(runner_pillars_caps, CYCLES_APPEAR, 139, 0, VLVCurved.CURVE_DEC_SINE_SQRT, new FSMesh[]{
